...
$.ajax({
	url : "user/MediaArticle/get_ArticleInfoByAjax",
	type : "post",
	dataType : "json",
	...
	success : function(msg) {
		...
		$(".last").attr("href","user/MediaArticle/get_article?id="+msg.lastid);
		$(".next").attr("href","user/MediaArticle/get_article?id="+msg.nextid);
