	...
	<body>
		...
		<div class="Sa_mid">
			...
			<div class="Sa_mid_right">
				<p class="Wal_mid_set mid_ser">公众媒体/<span><c:out value="${article.title }" /></span></p>
				<div class="Cont_text">
					<div class="Cont_tit">
...
$.ajax({
	url : "user/AdvisoryArticle/get_ArticleInfoByAjax",
	type : "post",
	dataType : "json",
	...
	success : function(msg) {
		...
		$(".last").attr("href","user/AdvisoryArticle/get_article?id="+msg.lastid);
		$(".next").attr("href","user/AdvisoryArticle/get_article?id="+msg.nextid);
