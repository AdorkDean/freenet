												...
												<c:forEach var="obj" items="${list}" varStatus="status">
													<tr class="gradeX">
														...
														<c:if test="${obj.status==1 }">
															...
															<td class=""><fmt:formatDate value="${obj.sellCdt}" pattern="yyyy-MM-dd HH:mm" /></td>
															<td class=""><fmt:formatDate value="${obj.realCdt}" pattern="yyyy-MM-dd HH:mm" /></td>
														</c:if>
														...
														<c:if test="${obj.status==3 }">
															<td><span class="label-danger">等待确认收款</span></td>
															<td class=""><fmt:formatDate value="${obj.sellCdt}" pattern="yyyy-MM-dd HH:mm" /></td>
															<td class="">---</td>
														</c:if>
														...
														<c:if test="${obj.status==7 }">
															<td><span class="label-danger">卖方发起违约</span></td>
															<td class=""><fmt:formatDate value="${obj.sellCdt}" pattern="yyyy-MM-dd HH:mm" /></td>
															<td class="">---</td>
														</c:if>
														...
														<td class="">
														<c:if test="${obj.status!=0&&obj.status!=6}">
