												...
												<tr class="gradeX">
													...
													<td class="am-text-middle">
														<div class="tpl-table-black-operation">
															<a
																href="manager/MediaArticle/toUpdate_article?id=<c:out value="${article.id}"/>">
																<i class="am-icon-pencil"></i> 编辑
															</a> <a
																href="manager/MediaArticle/delete_article?id=<c:out value="${article.id}"/>"
	...
	<script type="text/javascript">
		...
		$("#last_id").click(function () {
			...
			if(l_index>0){
				...
				//ajax获取页面内容
				$.ajax({
							url : "manager/MediaArticle/get_articleListByAjax",
							type : "post",
							dataType : "html",
