					...
					<div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
						<div class="widget am-cf">
							<div class="widget-head am-cf">
								<div class="widget-title  am-cf">媒体报道</div>
							</div>
												...
												<tr class="gradeX">
													...
													<td class="am-text-middle">
														<div class="tpl-table-black-operation">
															<a
																href="manager/media/toUpdate_article?id=<c:out value="${article.id}"/>">
																<i class="am-icon-pencil"></i> 编辑
															</a> <a
																href="manager/media/delete_article?id=<c:out value="${article.id}"/>"
									...
									<div class="am-fr">
										...
										<ul class="am-pagination tpl-pagination">
											<c:if test="${totalPages>1}">
												<li class=""><a   id="last_id">«</a></li>
											</c:if>
											<c:forEach var="i" begin="1" end="${totalPages}">
												<li class=""><a id="${i}" class="indexbutton"><c:out
															value="${i}" /></a></li>
											</c:forEach>
											<c:if test="${totalPages>1}">
												<li class=""><a  id="next_id">»</a></li>
											</c:if>
										</ul>
									</div>
								</div>
	...
	<script type="text/javascript">
		...
		$("#last_id").click(function () {
			...
			if(l_index>0){
				...
				//ajax获取页面内容
				$.ajax({
							url : "manager/media/get_articleListByAjax",
							type : "post",
							dataType : "html",
