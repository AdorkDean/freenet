...
<body data-type="widgets">
					...
					<div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
						<div class="widget am-cf">
							<div class="widget-head am-cf">
								<div class="widget-title am-fl">新增业内咨询</div>
							...
							<div class="widget-body am-fr">
								<form id="submitForm"
									...
									action="manager/AdvisoryArticle/add_article" method="post">
	...
	<script type="text/javascript">
		var id = "${article.id}";
		if (id > 0) {
			$("form").attr("action", "manager/AdvisoryArticle/update_article?id=" + id);
		}
