					...
					<div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
						<div class="widget am-cf">
							<div class="widget-head am-cf">
								<div class="widget-title  am-cf">业内咨询</div>
									...
									<div class="am-form-group">
										<div class="am-btn-toolbar">
											<div class="am-btn-group am-btn-group-xs">
												<a href="manager/web/addAdvisory"
											...
											<c:forEach items="${articleList}" begin="0" var="article">
												<tr class="gradeX">
													...
													<td class="am-text-middle"><fmt:formatDate
															pattern="yyyy-MM-dd" value="${article.releaseDate}" /></td>
													<td class="am-text-middle">
														<div class="tpl-table-black-operation">
															<a
																href="manager/AdvisoryArticle/toUpdate_article?id=<c:out value="${article.id}"/>">
																<i class="am-icon-pencil"></i> 编辑
															</a> <a
																href="manager/AdvisoryArticle/delete_article?id=<c:out value="${article.id}"/>"
				...
				.click(
						function() {
							...
							if (l_index > 0) {
								...
								$
										.ajax({
											url : "manager/AdvisoryArticle/get_articleListByAjax",
											type : "post",
											dataType : "html",
